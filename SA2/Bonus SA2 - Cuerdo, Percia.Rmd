...
From the plot above, it is evident that people who default tend to have much higer balances on average. This is a strong signal for predicting default.
...
nn_accuracy
```
The neural network achieves about r round(97.1% accuracy).
#### Final Comparsion
...
This suggests that the Neural Network was better able to capture complex patterns in the data, likely due to its ability to model nonlinear relationships. 
However, logistic regression still performed very well and is more interpretable.
